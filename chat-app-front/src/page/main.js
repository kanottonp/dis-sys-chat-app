		...
		return(
			<div>
				<nav className="w3-sidebar w3-bar-block w3-collapse w3-white w3-top w3-animate-left w3-card acontainer" style={navStyle} id="mySidebar">
  					...
  					<a href="#" className="w3-bar-item w3-button"><i className="fa fa-times-circle w3-margin-right"></i>Logout</a>
				</nav>
  					...
  					<div className="w3-modal-content w3-animate-zoom">
    					...
    					<div class="w3-panel">
      						...
      						<div className="w3-section">
        						<a></a>
        						<a className="w3-button w3-light-grey" onClick={this.closeJoin.bind(this)}>Join  <i className="fas fa-sign-in-alt w3-margin-right"></i></a>
      						</div>
    					</div>
  					</div>
				</div>
				...
				<div id="id02" className="w3-modal" style={{zIndex:"4"}}>
  					<div className="w3-modal-content w3-animate-zoom">
    					...
    					<div className="w3-panel">
      						...
      						<div className="w3-section">
        						<a></a>
        						<a className="w3-button w3-light-grey" onClick={this.closeGroup.bind(this)}>Create  <i className="fas fa-plus-circle w3-margin-right"></i></a>
      						</div>
    					</div>
  					</div>
				</div>
